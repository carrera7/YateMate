...
urlpatterns = [
    ...
    path("darDeBajaEmbarcacion/<int:publicacion_id>/<str:tipo>/",views.darDeBajaEmbarcacion, name="eliminarPublicacionEmbarcacion"),
    path("darDeBajaObjeto/<int:publicacion_id>/<str:tipo>/",views.darDeBajaObjeto, name="eliminarPublicacionObjeto"),
